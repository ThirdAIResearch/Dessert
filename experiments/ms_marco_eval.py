    ...
    for l in f:
        try:
            ...
            if qid in qid_to_ranked_candidate_passages:
                ...
                # Extend this to 10000 over the default of 1000
                tmp = [0] * 16384
...
def compute_metrics(qids_to_relevant_passageids, qids_to_ranked_candidate_passages):
    ...
    """
    recall_in_top_50 = 0
    recall_in_top_1000 = 0
    recall_in_top_10000 = 0
    all_scores = {}
    MRR = 0
    ...
    for qid in qids_to_ranked_candidate_passages:
        if qid in qids_to_relevant_passageids:
            ...
            if target_pid[0] in candidate_pid[:50]:
                recall_in_top_50 += 1
            if target_pid[0] in candidate_pid[:1000]:
                recall_in_top_1000 += 1
            if target_pid[0] in candidate_pid[:10000]:
                recall_in_top_10000 += 1
    ...
    all_scores["R@50"] = recall_in_top_50 / len(qids_to_relevant_passageids)
    all_scores["R@1000"] = recall_in_top_1000 / len(qids_to_relevant_passageids)
    all_scores["R@10000"] = recall_in_top_10000 / len(qids_to_relevant_passageids)
    return all_scores
